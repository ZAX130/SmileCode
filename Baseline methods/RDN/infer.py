...
def main():
    ...
    stages = 4
    levels = [4,4,4,4]
    model_folder = 'RDN({}, {}{}{}{})_ncc_{}_diffusion_{}_lr_{}/'.format(stages, *levels, weights[0], weights[1], lr)
    model_dir = 'experiments/' + model_folder
    model_idx = -1
    img_size = (160, 192, 160)
    model = RDN_test(img_size, stage_recursion=stages, level_recursion=levels)
