...
class Seg_norm(Base):
    def __init__(self, ):
        a = None
        self.seg_table = np.array([   0, 1002, 1003, 1005, 1006, 1007, 1008 ,1009, 1010, 1011, 1012, 1013, 1014 ,1015,
 1016, 1017, 1018, 1019, 1020,1021 ,1022, 1023, 1024, 1025 ,1026 ,1027, 1028, 1029,
 1030, 1031, 1034, 1035 ,2002 ,2003, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012,
 2013, 2014, 2015, 2016 ,2017 ,2018 ,2019, 2020 ,2021, 2022 ,2023 ,2024, 2025 ,2026,
 2027 ,2028 ,2029 ,2030 ,2031 ,2034 ,2035])#[0, 2, 3, 4, 5, 7, 8, 10, 11, 12, 13, 14, 15, 16, 17, 18, 24, 26,
...
class Seg_norm_5regions(Base):
    def __init__(self, ):
        a = None
        Frontal = [1000 + i for i in [3, 12, 14, 17, 18, 19, 20, 24, 27, 28]] + [2000 + j for j in
                                                                                       [3, 12, 14, 17, 18, 19, 20, 24,
                                                                                        27, 28]]
        ...
        self.seg_table = [Frontal, Parietal, Occipital, Temporal, Cingulate]
    def tf(self, img, k=0):
        if k == 0:
            return img
        img_out = np.zeros_like(img)
