...
from RDN_changes import RDN_diff, RDN
import random
...
def main():
    ...
    weights = [1, 1,1,1,1]  # loss weights
    lr = 0.0001
    stages = 4
    levels = [4,4,4,4]
    save_dir = 'RDN({}, {}{}{}{})_ncc_{}_diffusion_{}_lr_{}/'.format(stages, *levels, weights[0], weights[1], lr)
    ...
    Initialize model
    '''
    model = RDN(img_size, stage_recursion=stages, level_recursion=levels)
    model.cuda()
    ...
    criterions += [losses.Grad3d(penalty='l2')]*4
    best_dsc = 0
